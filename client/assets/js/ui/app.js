    ...
    var App = function () {
        ...
        var uiBlocks = function () {
            ...
            $('[data-toggle="block-option"]').on('click', function () {
                uiBlocksApi($(this).parents('.block'), $(this).data('action'));
            });
        };
        // Blocks API
        ...
        /*
         * $ Appear, for more examples you can check out https://github.com/bas2k/jquery.appear
         *
        ...
        /*
         * $ Appear + $ countTo, for more examples you can check out https://github.com/bas2k/jquery.appear and https://github.com/mhuggins/jquery-countTo
         *
        ...
        /*
         * Draggable items with $, for more examples you can check out https://jqueryui.com/sortable/
         *
